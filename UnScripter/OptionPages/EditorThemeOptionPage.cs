...
namespace UnScripter
{
    class EditorThemeOptionPage : OptionPage
    {
        ...
        [Inject]
        public EditorThemeOptionPage(EditorTabManager editorTabManager)
        {
        ...
        public void LoadThemeList()
        {
            ...
            var lasttheme = Globals.EditorSettings.GetTrait("EditorTheme", Path.Combine(kThemeDir, "dark.xml"));
